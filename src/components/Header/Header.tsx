    ...
    return (
        <header>
            ...
            <div className="headerBar container">
                ...
                {/* Mobile Menu */}
                <div className={`${styles.mobileMenu} ${isNavOpen ? "showNav" : "hideNav"}`}>
                    <div className={styles.mobileTopIcons}>
                        ...
                        <button 
                            className={styles.burgerNav}
                        > 
                            <CloseIcon fontSize="large" aria-label="hamburger menu" sx={{ color: grey[50] }} onClick={() => setIsNavOpen(false)}></CloseIcon>
                        </button>
                    </div>
